...
export default function UserLoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    login("user", name || "Investor", email)
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <Card className="border-2 shadow-xl">
          <CardHeader className="text-center pb-4">
            ...
            <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-violet-500/10 mx-auto mb-2">
              <User className="h-7 w-7 text-violet-500" />
            </div>
            <CardTitle className="text-2xl">Investor Login</CardTitle>
            <CardDescription>Access your investment and learning dashboard</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 text-center text-sm">
              ...
              <Link href="/auth/user/register" className="text-primary hover:underline font-medium">Sign up</Link>
            </div>
